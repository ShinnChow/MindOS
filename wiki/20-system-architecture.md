<!-- Last verified: 2026-04-04 | Current stage: v0.6 -->
...
│   │   └── settings/           # SettingsModal 拆分：types, Primitives, AiTab, AppearanceTab, KnowledgeTab, SyncTab, McpTab, UpdateTab, AgentsTab, McpAgentInstall, McpSkillsSection, McpSkillRow, McpSkillCreateForm, MonitoringTab, PluginsTab, ShortcutsTab, UninstallTab
│   ├── lib/                    # 核心模块
│   │   ├── fs.ts               # 文件系统操作
