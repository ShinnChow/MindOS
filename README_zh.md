...
可用工具：`mindos_list_files`、`mindos_read_file`、`mindos_write_file`、`mindos_create_file`、`mindos_delete_file`、`mindos_search_notes`、`mindos_get_recent`、`mindos_append_csv`
...
| `ANTHROPIC_API_KEY` | — | Anthropic 必填 |
