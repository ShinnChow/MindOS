...
- The zip file: `browser-extension/mindos-web-clipper.zip`
...
| **Privacy policy URL** | Host `store/privacy-policy.md` somewhere public, e.g.: `https://github.com/GeminiLight/MindOS/blob/main/browser-extension/store/privacy-policy.md` |
