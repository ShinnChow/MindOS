...
## Sync Rules (Configurations)

- On add: put new files into correct subdirectories (`Apps/`, `Agents/`, `Tools/`, `Orgs/`), then update `Configurations/README.md` tree.
- On rename/delete: update all references to affected paths.
- On troubleshooting updates: append pitfalls near related steps using a small table.
